...
if grep -q  'CSC=BTU\|CSC=CHT\|CSC=CHV\|CSC=DDE\|CSC=DHR\|CSC=DNL\|CSC=DPL\|CSC=ILO\|CSC=INS\|CSC=SER\|CSC=TTR\|CSC=THL\|CSC=UPO\|CSC=VD2\|CSC=VIA\|CSC=XAA\|CSC=XAC\|CSC=XSG' /tmp/aroma/csc.prop; then
